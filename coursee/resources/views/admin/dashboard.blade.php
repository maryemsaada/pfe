            ...
            <div class="container-fluid">
              ...
              <li class="nav-item topbar-icon dropdown hidden-caret d-flex d-lg-none">
                  ...
                  <ul class="dropdown-menu dropdown-search animated fadeIn">
                      <form action="{{ route('admin.dashboard') }}" method="GET" class="navbar-left navbar-form nav-search">
                          <div class="input-group">
                              <input type="text" name="search" placeholder="Search users..." class="form-control" 
                                     value="{{ request('search') }}">
                          </div>
...
<td>
    <div class="form-button-action">
        <a href="{{ route('profile.edit', $user->id) }}" class="btn btn-link btn-primary btn-lg">
